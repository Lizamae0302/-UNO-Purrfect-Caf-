...
$query = "SELECT COUNT(DISTINCT order_id) AS total_orders FROM orders WHERE staff_id = ?";
$stmt = $mysqli->prepare($query);
...
$query = "SELECT IFNULL(SUM(total_price), 0) AS total_sales FROM orders WHERE staff_id = ?";
$stmt = $mysqli->prepare($query);
$stmt->bind_param('i', $staff_id);
$stmt->execute();
$res = $stmt->get_result();
...
<div class="main-content">
  ...
  <div class="container-fluid mt--7">
    <div class="row mt-5">
      <div class="col-xl-12 mb-5 mb-xl-0" style="background-color: #F7E6CA;">
