...
if (isset($_POST['final_login'])) {
  ...
  $user_password = sha1(md5($_POST['user_password'])); // 🔐 Double encryption (replace with password_hash in future)
  ...
  if ($admin_found) {
    ...
    header("location:admin_dashboard.php"); // ✅ Your admin dashboard
    exit();
  }
  ...
  if ($staff_found) {
    ...
    header("location:dashboard.php"); // ✅ Your staff dashboard
    exit();
  }
...
<body class="bg-dark">
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <p class="text-lead text-light">Admin & Staff Portal</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <script>
    function checkUserNumber() {
      ...
      // Check ID for both admin and staff
      fetch('check_user_number.php', {
        method: 'POST',
