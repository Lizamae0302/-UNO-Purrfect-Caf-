  ...
  <div class="main-content">
    ...
    <div class="container-fluid mt--8" >
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="card shadow" style="height: 500px; overflow-y: auto; background-color: #F7E6CA;">
            <div class="card-header border-0" style="background-color: #F7E6CA;">
              <h3>Cart</h3>
            </div>
            <div class="table-responsive">
...
function openCustomerDisplay() {
  if (!customerWindow || customerWindow.closed) {
    customerWindow = window.open('customer_display.php', 'CustomerDisplay', 'width=600,height=800');
  }
}

openCustomerDisplay(); // Automatically opens on page load
function updateCart() {
    let cartBody = document.getElementById('cart-body');
    let totalPrice = 0;
    cartBody.innerHTML = '';
