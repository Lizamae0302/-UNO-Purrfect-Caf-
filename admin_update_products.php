...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <textarea name="details" class="box" required placeholder="update pet details" cols="30" rows="10"><?php echo $fetch_products['details']; ?></textarea>
   <input type="file" accept="image/jpg, image/jpeg, image/png" class="box" name="image">
   <input type="submit" value="update products" name="update_products" class="btn">
